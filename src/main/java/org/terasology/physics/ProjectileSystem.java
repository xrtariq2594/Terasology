...
public class ProjectileSystem implements EventHandlerSystem, UpdateSubscriberSystem {
    ...
    public void initialise() {
    	physicsSystem = CoreRegistry.get(PhysicsSystem.class);
    }
    ...
    public void removeProjectile(RemovedComponentEvent event, EntityRef entity) {
    	remove.add(entity);
    }
   
    @ReceiveEvent(components = {ProjectileComponent.class, LocationComponent.class}, priority = EventPriority.PRIORITY_NORMAL)
    public void addProjectile(AddComponentEvent event, EntityRef entity) {
    	add.add(entity);
    }    
   ...
   */
    ...
    */
    ...
    public void update(float delta) {
    	...
    	//TODO This will no longer be needed if Injection works correctly 
