...
public class PlayerFactory {
    ...
    public EntityRef newInstance(Vector3f spawnPosition) {
        ...
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:sword")));
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:bow1")));
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:bowDynamicPierce")));
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:bowKinematicPierce")));
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:bowDynamicRotate")));
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:bowKinematicRotate")));
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:bowKinematicRiccochet")));


        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:raytool")));
        chestContents.send(new ReceiveItemEvent(entityManager.create("combat:arrow")));
